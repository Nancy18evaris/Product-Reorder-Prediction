...
Achieved high precision and F1 score on filtered top 25 product categories. Model successfully predicts reorder behavior based on user-product patterns.
